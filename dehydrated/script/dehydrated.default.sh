...
function deploy_cert {
    ...
    DOMAINDIR="${DOMAIN/'*'/star}"
    mkdir -p /output/${DOMAINDIR}
    chmod 644 ${KEYFILE} ${CERTFILE} ${FULLCHAINFILE} ${CHAINFILE} /output/${DOMAINDIR}
    cp ${KEYFILE} ${CERTFILE} ${FULLCHAINFILE} ${CHAINFILE} /output/${DOMAINDIR}
